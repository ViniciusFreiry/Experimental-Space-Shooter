...
function set_stretch(_xscale, _yscale) {
	stretch_xscale = _xscale;
	stretch_yscale = _yscale;
}

function run_stretch(_lerp_percentage) {
...
function draw_stretch() {
	draw_sprite_ext(sprite_index, image_index, x, y, stretch_xscale, stretch_yscale, image_angle, image_blend, image_alpha);
}